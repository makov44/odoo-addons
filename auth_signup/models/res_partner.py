...
class ResPartner(models.Model):
    ...
    signup_code = fields.Char(copy=False)
    ...
    signup_email_verified = fields.Boolean(default=False)
    signup_phone_verified = fields.Boolean(default=False)
    ...
    def signup_retrieve_info(self, token):
        ...
        if partner.signup_valid:
            ...
            res['signup_phone_verified'] = partner.signup_phone_verified
            res['signup_email_verified'] = partner.signup_email_verified
        if partner.user_ids:
